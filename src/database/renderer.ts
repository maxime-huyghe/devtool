...
// k == kind
export type InstanceOrPort = { k: 'instance'; instanceName: string } | { k: 'port'; port: number }
...
export type AuthType = { k: 'default' } | { k: 'ntlm'; domain: string }
// Not using Azure
// | { k: 'azure-active-directory-password' }
// | { k: 'azure-active-directory-access-token' }
// | { k: 'azure-active-directory-msi-vm' }
// | { k: 'azure-active-directory-msi-app-service' }
...
export async function request(ipc: IpcRenderer, rq: string): Promise<ColumnValue[][]> {
